import type { ServiceOrdersApiResponse, GetServiceOrdersParams } from '../types'
import { getAuthHeaders } from '@/shared/utils/api'

const API_BASE_URL = 'http://localhost:3000'

export const serviceOrdersService = {
  async getServiceOrders(params: GetServiceOrdersParams = {}): Promise<ServiceOrdersApiResponse> {
