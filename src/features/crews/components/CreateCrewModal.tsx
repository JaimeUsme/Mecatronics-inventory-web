...
export function CreateCrewModal({ open, onClose }: CreateCrewModalProps) {
  ...
  const selectedTechnicians = technicians.filter((t) =>
        ...
        <form onSubmit={handleSubmit} className="px-6 pt-6 pb-6 space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
            ...
            <Button
              ...
              disabled={createCrew.isPending || !name.trim() || !leaderId}
            >
